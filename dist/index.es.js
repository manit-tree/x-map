 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ut, defineProperty: $t, getOwnPropertyDescriptor: mt, getOwnPropertyNames: _t, getOwnPropertySymbols: ft, getPrototypeOf: gt } = Object, _ = globalThis, G = _.trustedTypes, vt = G ? G.emptyScript : "", j = _.reactiveElementPolyfillSupport, S = (r, t) => r, N = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? vt : null;
      break;
  ...
  return e;
} }, W = (r, t) => !ut(r, t), Q = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: W };
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[S("elementProperties")] = /* @__PURE__ */ new Map(), A[S("finalized")] = /* @__PURE__ */ new Map(), j == null || j({ ReactiveElement: A }), (_.reactiveElementVersions ?? (_.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, z = C.trustedTypes, X = z ? z.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, nt = "$lit$", m = `lit$${Math.random().toFixed(9).slice(2)}$`, ht = "?" + m, At = `<${ht}>`, v = document, x = () => v.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", F = Array.isArray, yt = (r) => F(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", D = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Y = /-->/g, tt = />/g, f = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), et = /'/g, st = /"/g, at = /^(?:script|style|textarea|title)$/i, wt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), bt = wt(1), y = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), it = /* @__PURE__ */ new WeakMap(), g = v.createTreeWalker(v, 129);
function lt(r, t) {
...
const Et = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, d, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, d = o.exec(h), d !== null); ) u = o.lastIndex, o === E ? d[1] === "!--" ? o = Y : d[1] !== void 0 ? o = tt : d[2] !== void 0 ? (at.test(d[2]) && (i = RegExp("</" + d[2], "g")), o = f) : d[3] !== void 0 && (o = f) : o === f ? d[0] === ">" ? (o = i ?? E, l = -1) : d[1] === void 0 ? l = -2 : (l = o.lastIndex - d[2].length, c = d[1], o = d[3] === void 0 ? f : d[3] === '"' ? st : et) : o === st || o === et ? o = f : o === Y || o === tt ? o = E : (o = f, i = void 0);
    const $ = o === f && r[a + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + At : l >= 0 ? (s.push(c), h.slice(0, l) + nt + h.slice(l) + m + $) : h + m + (l === -2 ? a : $);
  }
    ...
    for (; (i = g.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(nt)) {
          const u = d[o++], $ = i.getAttribute(l).split(m), H = /([.?@])?(.*)/.exec(u);
          h.push({ type: 1, index: n, name: H[2], strings: $, ctor: H[1] === "." ? Ct : H[1] === "?" ? Pt : H[1] === "@" ? xt : L }), i.removeAttribute(l);
...
class T {
  ...
  _$AI(t, e = this) {
    t = w(this, t, e), U(t) ? t === p || t == null || t === "" ? (this._$AH !== p && this._$AR(), this._$AH = p) : t !== this._$AH && t !== y && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : yt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class L {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = w(this, t, e, 0), o = !U(t) || t !== this._$AH && t !== y, o && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = w(this, a[s + h], e, h), c === y && (c = this._$AH[h]), o || (o = !U(c) || c !== this._$AH[h]), c === p ? t = p : t !== p && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
I == null || I(M, T), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.2.1");
const Mt = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Tt = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: W }, Ht = (r = Tt, t, e) => {
...
let O = class extends P {
  constructor() {
    super(...arguments), this.lat = "13.926841663282733", this.lng = "100.52599680608748", this.zoom = 16, this.count = 0;
  }
  init() {
    ...
    this.map = new b.Map({
      ...
      zoom: this.zoom,
      container: t
    }), this.map.scrollZoom.disable(), this.marker = new b.Marker({
      color: "red"
    }), this.map.on("load", () => {
      const e = new b.NavigationControl({ showCompass: !1 });
      this.map.addControl(e, "top-right"), this.addMarker(), this.fadeOut(this.renderRoot.querySelector(".overlay"), 600, () => {
        this.renderRoot.classList.add("ready"), this.renderRoot.dispatchEvent(new CustomEvent("ready"));
      });
    });
  }
  addMarker() {
    this.marker && this.marker.remove(), this.marker = new b.Marker({ color: "red" }), this.marker.setLngLat([this.lng, this.lat]), this.marker.addTo(this.map);
  }
  fadeOut(r, t = 600, e) {
    let s = [
      { opacity: 1 },
    ...
    return typeof e == "function" && n.addEventListener("finish", (o) => {
      e();
    }), this;
  }
  setLocation(r, t) {
    return new Promise((e) => {
      this.renderRoot.setAttribute("lat", r), this.renderRoot.setAttribute("lng", t), setTimeout(() => {
        e();
      }, 1500);
    });
  }
  setPopup(r) {
    ...
    let t = new Array();
    t.push('<div class="info">'), t.push('<h4 class="title">' + (r.title ?? "ไอยารา ฟาร์มาซี") + "</h4>"), t.push('<p class="address">' + (r.address ?? "27/18 ต.บ้านใหม่ อ.ปากเกร็ด จ.นนทบุรี  11120") + "</p>"), r.tel && t.push('<p class="tel">' + R.phone + ' <a href="tel:' + r.tel + '" target="_blank">' + r.tel + "</a></p>"), r.email && t.push('<p class="email">' + R.email + ' <a href="mailto:' + r.email + '" target="_blank">' + r.email + "</a></p>"), t.push('<p class="location">' + R.marker + '<a href="https://www.google.com/maps?q=loc:' + this.lat + "," + this.lng + '" target="_blank">' + this.lat.substr(0, 9) + "," + this.lng.substr(0, 9) + "</a></p>"), t.push('<p class="direction">' + R.car + ' <a href="https://www.google.com/maps/dir/?api=1&destination=' + this.lat + "," + this.lng + '" target="_blank">วิธีการเดินทาง</a></p>'), t.push("</div>"), this.popup = new b.Popup().setHTML(t.join("")), this.marker.setPopup(this.popup);
  }
  createRenderRoot() {
    return this;
  }
